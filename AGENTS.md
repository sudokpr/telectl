...
- OwnTracks home filtering is visualization-only. Preserve raw MQTT logs, saved stop review data, and digest stop detection when changing `OWNTRACKS_HOME_FILTER_ENABLED`, `OWNTRACKS_HOME_REGION_NAMES`, or `OWNTRACKS_HOME_FILTER_RADIUS_METERS`.
